...
sys.path.append("/home/litt/Projects/unitree_legged_sdk/lib/python/amd64")
...
if __name__ == "__main__":
    ...
    udp = sdk.UDP(
        LOCAL_PORT, TARGET_IP, TARGET_PORT, LOW_CMD_LENGTH, LOW_STATE_LENGTH, -1
    )
